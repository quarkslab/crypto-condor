...
class FalconNistKatTest(_message.Message):
...
class FalconNistKatVectors(_message.Message):
    __slots__ = ["name", "tests"]
    NAME_FIELD_NUMBER: _ClassVar[int]
    TESTS_FIELD_NUMBER: _ClassVar[int]
    name: str
    tests: _containers.RepeatedCompositeFieldContainer[FalconNistKatTest]
    def __init__(self, name: _Optional[str] = ..., tests: _Optional[_Iterable[_Union[FalconNistKatTest, _Mapping]]] = ...) -> None: ...
