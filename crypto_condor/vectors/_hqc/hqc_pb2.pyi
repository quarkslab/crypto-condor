...
@typing.final
class HqcTest(google.protobuf.message.Message):
...
global___HqcTest = HqcTest

@typing.final
class HqcVectors(google.protobuf.message.Message):
    ...
    @property
    def tests(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___HqcTest]:
        """The test vectors."""
    ...
    def __init__(
        ...
        *,
        ...
        tests: collections.abc.Iterable[global___HqcTest] | None = ...,
        paramset: builtins.str = ...,
    ) -> None: ...
...
global___HqcVectors = HqcVectors
