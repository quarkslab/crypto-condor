...
void CC_MLDSA_sign_mldsa44(uint8_t *sig, size_t siglen, const uint8_t *msg,
                           size_t msglen, const uint8_t *ctx, size_t ctxlen,
  ...
  void (*sign)(uint8_t *, size_t *, const uint8_t *, const size_t,
               const uint8_t *, const size_t, const uint8_t *);
...
void CC_MLDSA_sign_mldsa65(uint8_t *sig, size_t siglen, const uint8_t *msg,
                           size_t msglen, const uint8_t *ctx, size_t ctxlen,
                           const uint8_t *sk, size_t sklen) {
...
void CC_MLDSA_sign_mldsa87(uint8_t *sig, size_t siglen, const uint8_t *msg,
                           size_t msglen, const uint8_t *ctx, size_t ctxlen,
                           const uint8_t *sk, size_t sklen) {
...
int CC_MLDSA_verify_mldsa44(const uint8_t *sig, size_t siglen,
...
int CC_MLDSA_verify_mldsa65(const uint8_t *sig, size_t siglen,
                            const uint8_t *msg, size_t msglen,
                            const uint8_t *ctx, size_t ctxlen,
                            const uint8_t *pk, size_t pklen) {
  void *handle = get_lib_handle("ML-DSA-65-ref.so");
...
int CC_MLDSA_verify_mldsa87(const uint8_t *sig, size_t siglen,
                            const uint8_t *msg, size_t msglen,
                            const uint8_t *ctx, size_t ctxlen,
                            const uint8_t *pk, size_t pklen) {
  void *handle = get_lib_handle("ML-DSA-87-ref.so");
