...
int CC_AES_decrypt_ECB_256(uint8_t *plaintext, size_t plaintext_size,
                           const uint8_t *ciphertext, size_t ciphertext_size,
...
int CC_AES_decrypt_CTR_256(uint8_t *plaintext, size_t plaintext_size,
                           const uint8_t *ciphertext, size_t ciphertext_size,
                           const uint8_t *key, size_t key_size,
                           const uint8_t *iv, size_t iv_size) {
...
int CC_AES_decrypt_CFB8_256(uint8_t *plaintext, size_t plaintext_size,
                            const uint8_t *ciphertext, size_t ciphertext_size,
                            const uint8_t *key, size_t key_size,
                            const uint8_t *iv, size_t iv_size) {
...
int CC_AES_decrypt_CFB128_256(uint8_t *plaintext, size_t plaintext_size,
                              const uint8_t *ciphertext, size_t ciphertext_size,
                              const uint8_t *key, size_t key_size,
                              const uint8_t *iv, size_t iv_size) {
...
int CC_AES_decrypt_CBCPKCS7_256(uint8_t *plaintext, size_t plaintext_size,
                                const uint8_t *ciphertext,
                                size_t ciphertext_size, const uint8_t *key,
